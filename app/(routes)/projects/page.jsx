...
const Projects = () => {
  ...
  return (
   ...
   <Image src="/spotify.png" fill alt="project image" className=" absolute object-fit" />
   </div>
  
   <p className=" text-center text-sm font-bold">Spotify Clone</p>
   <p className=" text-xs">Fullstack Development</p>
   <p className=" mt-2 text-xs text-left"><span className="font-bold">Takeaway from this project: <br/></span>
